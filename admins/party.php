...
border-radius:5px;">
<br>
<a class="lest" href="print.php?id=all">All</a>
<a class="lest" href="print.php?id=acc">Accomdation</a>
<?php
...
?>
<a class="lest" href="print.php?id=<?php echo $row['id'];?>"><?php echo $row['title'];?></a>
<?php	
}
	mysql_close($link);  
?>
